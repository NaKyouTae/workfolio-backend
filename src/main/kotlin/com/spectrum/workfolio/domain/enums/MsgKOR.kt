...
enum class MsgKOR(val message: String) {
    ...
    NOT_FOUND_STAFF("존재하지 않는 관리자입니다."),
    ALREADY_EXISTS_STAFF_USERNAME("이미 존재하는 아이디입니다."),
    ALREADY_EXISTS_STAFF_EMAIL("이미 존재하는 이메일입니다."),
    INVALID_STAFF_CREDENTIALS("아이디 또는 비밀번호가 올바르지 않습니다."),
    INACTIVE_STAFF("비활성 상태의 관리자입니다."),
    INVALID_OLD_PASSWORD("기존 비밀번호가 일치하지 않습니다."),
